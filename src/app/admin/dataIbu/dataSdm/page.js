...
import { useSdmPeriod } from "@/hooks/hooksIbu/sdm/useSdmPeriod";
import { useSdmExport } from "@/hooks/hooksIbu/sdm/useSdmExport";
import PeriodeBulanCard from "@/components/shared/PeriodeBulanCard";
import SdmTable from "@/components/comIbu/sdm/table/SdmTable";
        ...
        <div>
          ...
          <p className="text-xs text-gray-500 mt-0.5">
            ...
            <span className="text-blue-600">
              data kumulatif (sudah termasuk bulan sebelumnya)
            </span>
          </p>
        </div>
