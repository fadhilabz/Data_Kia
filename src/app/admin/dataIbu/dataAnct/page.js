...
import { useAnctPeriod } from "@/hooks/hooksIbu/anct/useAnctPeriod";
import { useAnctExport } from "@/hooks/hooksIbu/anct/useAnctExport";
import PeriodeBulanCard from "@/components/shared/PeriodeBulanCard";
import AnctTable from "@/components/comIbu/anct/table/AnctTable";
      ...
      <div className="flex justify-center items-center h-screen bg-gray-50">
        <div className="text-center space-y-3">
          ...
          <p className="text-gray-600 font-medium text-xs">
            Memuat Laporan Data ANC Terpadu...
          </p>
        </div>
      </div>
    );
