// components/pnc/form/PncFormHeader.jsx
export default function PncFormHeader({ puskesmasName, targetBulin, autoSaveStatus, isEditable, periodLabel }) {
  return (
    <header className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-outline-variant pb-4">
      <div>
        ...
        <div className="flex items-center gap-2 mt-1 text-on-surface-variant font-body-md text-body-md">
          ...
          <span>•</span>
          <span>Target BULIN: <strong>{targetBulin}</strong> orang</span>
        </div>
      </div>
