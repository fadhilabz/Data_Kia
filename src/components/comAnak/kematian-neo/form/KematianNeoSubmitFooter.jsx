// components/kematian-neo/form/KematianNeoSubmitFooter.jsx
// Bukan wizard multi-step — halaman ini 1 layar scroll (3 seksi umur),
// jadi footernya cuma 1 tombol submit final, tanpa navigasi step.

"use client";

export default function KematianNeoSubmitFooter({ onSubmit, saving, isEditable, periodDocExists }) {
