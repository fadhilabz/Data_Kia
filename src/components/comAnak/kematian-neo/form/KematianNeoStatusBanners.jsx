// components/kematian-neo/form/KematianNeoStatusBanners.jsx
"use client";

export default function KematianNeoStatusBanners({ periodDocExists, isReadOnly, periodLabel }) {
  if (isReadOnly) {
    return (
    ...
    return (
      <div className="p-3 bg-amber-50 border border-amber-200 rounded-xl text-amber-900 text-xs flex items-start gap-2">
        ...
        <div>
          ...
          <p>Dokumen pelaporan Kematian Neonatal untuk {periodLabel} belum pernah diinisialisasi oleh Admin Dinas Kesehatan.</p>
        </div>
      </div>
    );
  }
