// components/comAnak/kmb/form/KmbFormHeader.jsx
"use client";

export default function KmbFormHeader({ puskesmasName, autoSaveStatus, isEditable, periodLabel, jumlahKasus }) {
  return (
