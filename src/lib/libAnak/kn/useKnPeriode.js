// lib/libAnak/kn/useKnPeriode.js
// Hook periode KN — pola identik lib/anct/useAnctPeriode.js dan versi PNC
// yang sudah diperbaiki: baca status dari useManajemenPeriode()
// (settings/period_statuses), SATU sumber yang sama dipakai semua modul.
...
export function useKnPeriode({ isAdmin } = {}) {
  const {
    selectedYear,
    openedMonths,
    statusPeriodeMap,
