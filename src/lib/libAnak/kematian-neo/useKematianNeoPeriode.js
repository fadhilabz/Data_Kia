// lib/kematian-neo/useKematianNeoPeriode.js
// Pola identik lib/kn/useKnPeriode.js / lib/anct/useAnctPeriode.js.
...
export function useKematianNeoPeriode({ isAdmin } = {}) {
  const {
    selectedYear,
    openedMonths,
    statusPeriodeMap,
  ...
  const DAFTAR_BULAN_ID = ["01","02","03","04","05","06","07","08","09","10","11","12"];
